...
const dict: Record<Lang, Translations> = {
  en: {
    ...
    forgotPasswordSent: "If that email has an account, a reset link is on its way — check your spam folder if it doesn't show up.",
    ...
    verifyEmailSent: "Account created — check your email for a link to verify your account before logging in. Don't see it? Check your spam folder too.",
    verifying: "Verifying…",
    ...
    emailNotVerified: "Please verify your email before logging in — check your inbox (and spam folder) for the link.",
    resendVerification: "Resend verification email",
    resendVerificationSent: "If that email has an unverified account, a new verification link is on its way — check your spam folder if it doesn't show up.",
    helpPage: {
  ...
  cs: {
    ...
    forgotPasswordSent: "Pokud k tomuto e-mailu existuje účet, odkaz na obnovení je na cestě — pokud nedorazí, zkontrolujte složku Spam.",
    ...
    verifyEmailSent: "Účet vytvořen — zkontrolujte svůj e-mail a klikněte na odkaz pro ověření účtu před přihlášením. Nevidíte ho? Podívejte se i do složky Spam.",
    verifying: "Ověřování…",
    ...
    emailNotVerified: "Před přihlášením prosím ověřte svůj e-mail — zkontrolujte doručenou poštu (i složku Spam), kam jsme poslali odkaz.",
    resendVerification: "Znovu odeslat ověřovací e-mail",
    resendVerificationSent: "Pokud má tento e-mail neověřený účet, nový ověřovací odkaz je na cestě — pokud nedorazí, zkontrolujte složku Spam.",
    helpPage: {
